...
// https://gist.github.com/alexedwards/34277fae0f48abe36822b375f0f6a621
...
func (a *Argon2Params) GenerateFromPassword(password string) (encodedHash string, err error) {
...
func (a *Argon2Params) ComparePasswordAndHash(password, encodedHash string) (match bool, err error) {
